...
@section('content')
    <div class="content-wrapper">
        <div class="px-6">
            ...
            <form action="{{ route('employees.store') }}" method="POST" class="bg-white shadow-md rounded-lg p-6 w-full">
                @csrf
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex space-x-2">
                        <button type="button" data-status="active"
                                class="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 transition duration-200 {{ old('status') == 'active' ? 'bg-green-600' : '' }}"
                        ...
                        <button type="button" data-status="inactive"
                                class="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 transition duration-200 {{ old('status') == 'inactive' ? 'bg-red-600' : '' }}"
